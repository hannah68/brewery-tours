...
const createListSectionDisplay = (state,value) => {
...
// // filter by type data
// const filterByTypeData = (allData,value,type) => {
//   const filteredArr = allData.filter(data => {
//     if(data.state){
//       if(data.state.toLowerCase() === value){
//         return data
//       }
//     }
...
// // fetch data by type
// const fetchByType = (type,value) => {
//   fetch(`https://api.openbrewerydb.org/breweries?by_type=${type}`)
//     .then(res => res.json())
//     .then(allData => {
//       console.log(allData);
//       filterByTypeData(allData,value,type);
//     })
// }


// const listenToFilterByType = (value,state) => {
//   const selectType = document.getElementById('filter-by-type');
//     selectType.addEventListener('change', () => {
//         emptyList();
//         if(selectType.value === 'micro'){
//           console.log('micro===');
//           fetchByType('micro',value);
//         }
//         if(selectType.value === 'regional'){
//           fetchByType('regional',value);
//         }
//         if(selectType.value === 'brewpub'){
//           console.log('brewpub===');
//           fetchByType('brewpub',value);
